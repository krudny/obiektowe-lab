...
2. Poniższy obrazek ilustruje metody `precedes` i `follows`. `v1` poprzedza (precedes) `v2` oraz `v3`. `v2` poprzedza `v3`.
   ...
   `v1`, `v2` następuje po `v1`. Wszystkie wektory następują również po samych sobie.
      ...
      <img src="https://raw.githubusercontent.com/Soamid/obiektowe-lab/refs/heads/master/lab2/vector2d.png" width="600" alt="wektory" align="center" />

2. Poniższy obrazek ilustruje metody `lowerLeft` oraz `upperRight`.
   
      <img src="https://raw.githubusercontent.com/Soamid/obiektowe-lab/refs/heads/master/lab2/vector2d-a.png" width="600" alt="rogi" align="center" />
